...
export const ReportesSabana = () => {
  ...
  const [
    ...
    {
      data: genReporteRsp,
      isLoading: isLoadingGenReporte,
      error: genReporteError,
    },
  ] = useGenerarReporteMutation();
  const [
    convertirMoneda,
  ...
  const _filenameCellComponent = useCallback(
    (rowData: ColumnCellTemplateData) => {
      return (
        <a
          target="_blank"
          href={`${apiHost}/Reportes/${rowData.data.Filename}`}
        >
          Descargar
        </a>
      );
  ...
  return (
    <>
      <div className="p-6">
        <div className="mb-6">
          <AdminBreadcrumbs
            links={[{ name: "Reportes", href: `${apiHost}/#/reportes/` }]}
          />
        </div>
        ...
        <div className="mb-6 lg:flex items-center justify-between gap-4 lg:w-full">
          ...
          <div className="flex-1 mb-4 lg:mb-0">
            ...
            <Datepicker
              displayFormat="DD-MM-YYYY"
              value={fechaDivisas}
              onChange={_handleDivisaDateChange}
              showFooter={false}
              asSingle
            />
            {/* <TextInput
        ...
        {!conversionIsLoading && conversionRes && (
          <div className="mb-6">
            Utilizando tipo de cambio: {conversionRes?.DataString}
          </div>
        )}
        ...
        <div className="mb-6">
          {reportesRsp && !isLoadingReportes && (
            ...
            >
              ...
              <Column
                dataField="Descarga"
                cellRender={_filenameCellComponent}
              />
            </DataGrid>
          )}
        </div>
